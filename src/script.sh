...
scp src/C3_SimpleBashUtils-0/cat/s21_cat janiecee@192.68.1.2:/usr/local/bin
scp src/C3_SimpleBashUtils-0/grep/s21_grep janiecee@192.68.1.2:/usr/local/bin
